...
import { ArrowRight, Filter, Check, Clock, Tool } from "lucide-react";
import { Button } from "@/components/ui/button";
import { useLocation, Link } from "react-router-dom";

// Extended project data with status
const projects = [
  {
    id: 1,
...
const statuses = ["All", "Completed", "Ongoing", "Renovated"];
  ...
  useEffect(() => {
    ...
    if (activeStatus !== "All") {
      filtered = filtered.filter(project => 
        project.status === activeStatus.toLowerCase()
      );
    }
    
    setVisibleProjects(filtered);
    
    // Scroll to top when changing categories or viewing project details
    window.scrollTo(0, 0);
  }, [activeCategory, activeStatus, location.search]);
      ...
      <div className="bg-primary/5 py-16 mt-16">
        <div className="container">
          ...
          <p className="text-muted-foreground max-w-2xl">
            Browse our completed works, ongoing projects, and renovations. See the quality and craftsmanship that MjengoSafi delivers across various sectors.
          </p>
        </div>
      </div>
        ...
        <div className="container">
          ...
          {selectedProject ? (
            ...
            <div className="animate-fade-in">
              ...
              >
                <ArrowRight size={16} className="mr-2 rotate-180" /> Back to gallery
              </Link>
                  ...
                  {projects
                    ...
                    .map(project => (
                      <div 
                        ...
                        onClick={() => {
                          setSelectedProject(project);
                          window.history.pushState({}, '', `/project-gallery?id=${project.id}`);
                        }}
                      >
